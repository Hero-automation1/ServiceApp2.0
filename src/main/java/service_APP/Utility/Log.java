...
//		((Object) reporter.config()).setChartVisibilityOnOpen(false);
		reporter.config().setDocumentTitle("Hero Service2.0 APP");
		reporter.config().setReportName("Hero Service2.0 APP Automation Report");
//		reporter.config().setTestViewChartLocation(ChartLocation.TOP);
		reporter.config().setTheme(Theme.DARK);
		reporter.config().setTimeStampFormat("EEEE, MMMM dd, yyyy, hh:mm a '('zzz')'");
		extent = new ExtentReports();
		extent.attachReporter(Log.reporter);
		extent.setSystemInfo("Project Name", "Hero Service2.0 APP");
...
//		extent.setSystemInfo("Device", "Pixel 4");
		extent.setSystemInfo("Test Engineer", "Lalit Aggarwal");
	}
//=========================================================================================================================
